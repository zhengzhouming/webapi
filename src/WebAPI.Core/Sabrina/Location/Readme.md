...
```
        ...
        {
            modelBuilder.ApplyConfiguration(new LocationsCfg());
        }
...
<text name="L_Size"  value="L_Size"></text>
<text name="X_location"  value="X_location"></text>
<text name="Y_location"  value="Y_location"></text>
<text name="Create_pc"  value="Create_pc"></text>
<text name="Update_date"  value="Update_date"></text>


<text name="Locations" value=""></text><text name="QueryLocations"  value="查询"></text><text name="CreateLocations"  value="添加"></text><text name="EditLocations"  value="编辑"></text><text name="DeleteLocations"  value="删除"></text><text name="BatchDeleteLocations" value="批量删除"></text><text name="ExportLocations"  value="导出"></text>                             
