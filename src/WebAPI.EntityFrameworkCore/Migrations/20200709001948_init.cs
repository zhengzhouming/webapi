        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    PPR_id = table.Column<string>(nullable: true),
                    Cust_id = table.Column<string>(nullable: true),
                    Serial_From = table.Column<string>(nullable: true),
                    Qty = table.Column<int>(nullable: true),
                    Org = table.Column<string>(nullable: true),
                    PPrfNo = table.Column<string>(nullable: true),
                    Count1 = table.Column<int>(nullable: true),
                    Create_Pc = table.Column<string>(nullable: true),
                    Update_Date = table.Column<DateTime>(nullable: true),
                    Con_no = table.Column<int>(nullable: true),
                    Country_Code = table.Column<string>(nullable: true),
                    Con_To = table.Column<int>(nullable: true),
                    Pkg_Code = table.Column<string>(nullable: true),
                    Scan_ID = table.Column<string>(nullable: true),
                    Net_Net = table.Column<float>(nullable: true),
                    Con_Net = table.Column<float>(nullable: true),
                    Con_Gross = table.Column<float>(nullable: true),
                    Con_L = table.Column<float>(nullable: true),
                    Con_W = table.Column<float>(nullable: true),
                    Con_H = table.Column<float>(nullable: true),
                    B_Volume = table.Column<float>(nullable: true),
                    PO = table.Column<string>(nullable: true),
                    MAIN_LINE = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConPprs", x => x.Id);
                });
