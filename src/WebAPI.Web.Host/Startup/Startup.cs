...
namespace WebAPI.Web.Host.Startup
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            {
                options.SwaggerEndpoint(_appConfiguration["App:ServerRootAddress"].EnsureEndsWith('/') + "swagger/v1/swagger.json", "WebAPI API V1");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("WebAPI.Web.Host.wwwroot.swagger.ui.index.html");
            }); // URL: /swagger
        }
    }
}